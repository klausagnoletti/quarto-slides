...
subtitle: "Why Dungeons & Dragon, is the powerful security tool you didn't know you need."
title-slide-attributes: 
  data-notes: "**Script:** Welcome to my talk on how to use Dungeons & Dragons in game-based learning and how it's the power tool you didn't know you needed."
---

## What's the problem with training in general?
...
But in incident response training it's different.    
Tabletops are widely used and can be seen as 'the way' to teach this. And yes, it can be - depending on how it's done.  
Oftentimes it's dull and not very realistic in that it consists of people sitting around a table and talking about ficatious situations and which mitigating procedures are available.
...
Another example is personal dependencies; one person can't do everything. They don't have enough bandwidth. And what if that person got run over by a bus? You're screwed!   
So, what is the state of your security really? You might show things differently to a colleague, a partner and a boss.  
Ego, pride and consequences to employment can conflict with honesty.
...
::: aside
Article from the media [Frontiers in Psychology](https://www.frontiersin.org/): [Playing at the school table: Systematic literature review of board, tabletop, and other analog game-based learning approaches](https://www.frontiersin.org/articles/10.3389/fpsyg.2023.1160591/full)
:::

::: {.notes}
**Script:**  
To me, it’s obvious that you learn better, when you’re having fun.  
Fortunately science agrees. The article is a metastudy of board, tabletop, and other analog game-based learning approaches.  
Playing games is fun - while learning  
Contrary to what some believe, fun can be serious business.  
You *can* spend your time wisely and productively while having fun - believe it or not.  
:::
<!--
...
:::
-->
## Your brain is wired for learning with others (1/2) {.smaller}
...
::: {.notes}
**Script:** 
There are many ways of implementing 'learning together as a team'.  
We want to do it as a role-playing game because of real-life experience with both incident response (IR) tabletops as well as Dungeons & Dragons.  
Luckily, science, again, agrees with us:  
*next slide*  
:::
...
**Script:**  
*note: Read quote*  
So according to this, there's no reason to think that D&D-derivates can't be used to do effective IR training.  
...
There's several phases of this:

- Awkwardness
- When broken, people ease up and laugh a lot.
And that's good. Laughing is good. Laughing is engagement.  
Put on edge I think that this is a core reason why role playing games works so well for this.  
:::
...
::: {.notes}
**Script:**  
Incident Response doesn’t have to be so tense and dull!  
When playing a simulated scenario, you’ll laugh instead of stressing, and enjoy yourself instead of dreading the consequences.  
When you’re able to lighten up, you’ll be able to actually focus on the task, instead of protecting your turf, playing up your ego and playing down the situation. 
What's important here, of course, is that you're more honest.  
...
::: {.notes}
**Script:**  
As a bonus you get advantages you simply can't have in an ordinary tabletop exercise, such as empathy and a more lifelike simulation.  
Let me explain.  
Roleplaying allows players see the world from a different perspective.  
Imagine putting a very technical and logical person in the role of 'head of communications'. They might suddenly realize how important stakeholder management is during an incident.  
This in turn improves teamwork - along with other players rotating roles as well.  
Since it's a simulation it means that players get to be aware of obvious limitations such as personal dependencies.  
One person can't do it all at once.  
And what if that person gets run down by a bus?  
Role playing games can be used in IR training.  
...
::: {.notes}
**Script:**  
HackBack has a wide range of applications. I see a game like this as the security tool you didn't know you needed.  
HackBack can be the alternative to that class- or computer-based training no one wants to do and doesn't seem to work anyway.  
We've simply chosen to use it for security because.... that's what we do.  
But in reality it could be anything.  
Also it's open-source as we want to spread the word about it and make it freely available to all.  
This means that all characters, scenarios and guidance on planning and running games is available on GitHub as markdown. 
...
So yes, it is possible to earn money on open-source. Also when it's a role playing game.
:::
...
::: {.notes}
**Script:**  
So at one time we came up with combining IR tabletops with Dungeons & Dragons. More precisely it happened to me in Vegas in 2018 when I heard the then CISO of Expel, Bruce Potter, talk about how he and his son Bobby, an avid D&D player, had turned D&D into IR training. What stuck with me from that experience is that Bruce said that since they started doing this, the perception of IR training had shifted from being something nobody wanted to partake in, into an event that was sought out and requested. To me that was mindblowing since in reality this is what we want as security professionals. And here was a tool that provided that.
...
It can be used to make abstract concepts more concrete. For instance, why does IAM matter? And what's Zero Trust **really** about (now that it's not a fancy product you can buy).  
HackBack can be used to teach sales and marketing how it feels to be in the middle of an incident or how a hacker thinks. That gives them a better understanding so they're better at their job.  
...
HackBack can be scaled up and down to improve general awareness, or something super specific. Instead of one character playing a role, a team plays that role. Depending on the purpose of the game, your internal security team could be divided so that teams end up having more of those quality discussions where they actually learn.  
Since HackBack can simulate real events, it can be used to teach employees, customers or other stakeholders how your company work on your red team assignments, It can be used it to make customers or partners understand exactly how you managed to handle that dire incident which was threatening the entire company or country's infrastructure.  
The possibilities are endless. It's just a matter of getting the right idea...
:::
...
::: {.notes}
**Script:** 
As I said before, HackBack is currently mostly used as incident response training. So let me briefly go through the rules to give you a better understanding of how it works.    
...
Just as in Dungeons & Dragons, characters have modifiers outlining their talents and personality. The Microsoft System Architect has -2 in likeability because everyone find them really annoying.  
Similarly the Level 1 supporter is very outgoing and likeable, very eager to learn about anything going on in the company.  
Obviously they have a +2 in likeability, meaning that when they call someone, the person on the receiving end actually want to pick up the phone to talk to them.  
Each game usually consists of three rounds taking place within the same scenario but on different points in time. Games often start on a Friday afternoon since incidents usually happen at the worst time imaginable.  
Each character has two actions in each round. An action is anything they actively do in the game.  
This means that going out of character, talking internally among players on what to do is not an action and can always be done at any time in the game.  
When the player decided on what they do, they roll a 20-sided dice and depending on how difficult the IM deems it to be (easy, medium or high), they have to roll over 5, 10 or 15. And if any modifiers are in place they will be added or subtracted.  
...
Similarly, players don't get optimal learning if they roll high all the time and everything's a breeze.  
Everybody in Incident Response know that it's never that easy.   
The role of the IM is to adjust the level of the game to that sweet spot.
...
It's definitely an advantage for an IM to have experience as a Dungeon Master in Dungeons & Dragons - but it's not a requirement. 
...
Oftentimes compliance in general is not very fun or interesting for most people involved.  
...
Reach out to me:  
Klaus Agnoletti  
[klaus@relationsec.net](klaus@relationsec.net)
