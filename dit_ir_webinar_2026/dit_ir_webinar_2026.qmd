...
## {background-image="images/hero-december-desk.jpg" background-opacity="0.4" background-size="cover" auto-animate="true"}

[December. An email from the butcher.]{.hero-line data-id="cold"}
...
## {.vcenter auto-animate="true"}

[Everyone clicks. The question is what happens after.]{.hero-line style="font-size:2.4em;" data-id="cold"}
...
- Callback target for slide 31, say it cleanly
:::

## An exercise can also end up as SAY.
...
::: {.dial-wrap}
![](svg/dial.svg)
[3%]{.dial-readout .fragment .fx style="opacity:1;"}
[30%]{.dial-readout .fragment .fx}
:::

::: {.notes}
- So the question isn't whether you practice, it's whether the exercise changes what people DO. And the number most people look at is the click rate from the phishing test.
- Whoever runs the phishing test decides how hard it is. The click rate is a dial you can turn. Not a measurement. And it's what decides who "failed".
- Trust cost: "…and afterward, hardly anyone feels good about being told they fell for it."
- It takes ONE click to compromise the entire organization. So a low number proves nothing.
- ~50-55s total, don't linger
:::

## IT is not a cost. IT is a precondition.
...
## The plan only lives on paper. {background-image="images/hero-dead-document.jpg" background-opacity="0.35" background-size="cover"}
...
![](svg/ecg.svg){style="width:100%; height:auto; display:block;"}
:::
...
::: {.feature-grid style="--fg-cols:4; font-size:0.65em;"}
- An IR plan in SharePoint. Last opened two years ago.
- An exercise you only run because NIS2 requires it.
- A slideshow, read aloud. Box ticked.
- Only IT sits at the table. Everyone else shows up when it's already too late.
:::
...
- Callback: "What you've PRACTICED is all you've got" (slide 11), this slide names WHY that's true
- Forward-plants slide 21's information-drop beat
- Bridge: "And that's why the FORMAT matters. Not gamification. Game-based learning."
:::

## {.feature-grid .vcenter style="--fg-cols:2;"}

- Gamification: points, badges, cake
- Game-based learning: the game IS the learning

::: {style="max-width:560px; margin:0.8em auto 0;"}
![](svg/gamification-vs-gbl.svg){style="width:100%; height:auto; display:block;"}
:::
...
::: {.seat-diagram}
![](svg/table-seats.svg)
[]{.seat-dot .s1 .fragment .fx}
[]{.seat-dot .s2 .fragment .fx}
[]{.seat-dot .s3 .fragment .fx}
[]{.seat-dot .s4 .fragment .fx}
[]{.seat-dot .s5 .fragment .fx}
[]{.seat-dot .s6 .fragment .fx}
:::
...
- The technician plays comms chief → empathy for that seat under pressure
...
::: {.card style="text-align:center; max-width:640px; margin:0 auto;"}
[NOW WE DO IT. TWO ROUNDS. THEN IT'S YOU.]{style="font-family:'Bebas Neue',sans-serif; font-size:1.5em;"}
:::

::: {.notes}
- To rounds shown narrated (Klaus plays all seats), so everyone sees the shape once
- Round 3 is real: the room decides live
...
::: {style="max-width:260px; margin:0.8em auto 0;"}
...
## Deliberation is free. Action costs a dice roll.
...
::: {style="max-width:130px; margin:0.6em auto 0;"}
![](svg/d20.svg){style="width:100%; height:auto; display:block;"}
:::
...
- Reveal, anonymized composite: across the sessions I've run, tables split roughly like this, and each choice cost something later in the game [KLAUS: fill your real split + costs]
...
## You're scored on your reasoning. Not on the right answer.

::: {.notes}
- Scored on REASONING under incomplete information, not on guessing the true state
- One clause of design framing, max
- Starter guide: free, malwareandmonsters.com, full CTA waits till the end
:::

## {background-iframe="https://malwareandmonsters.com" background-interactive="true"}

::: {.notes}
- Navigate live, ~60-90s: homepage → starter guide → a scenario card
...
## {.vcenter visibility="uncounted"}

::: {style="width:120px; margin:0 auto 1em;"}
...
::: {.notes}
- FALLBACK ONLY, jump here if the live iframe misbehaves
...
::: {.card style="text-align:center; max-width:640px; margin:0 auto;"}
[SHOULD ≠ DO]{style="font-family:'Bebas Neue',sans-serif; font-size:2em; letter-spacing:0.03em; color:var(--accent);"}
:::

::: {.notes}
- Verbatim: "Surveys don't tell you what people DO in a situation. They tell you what people SHOULD do. And that's not the same thing."
- Short pause. "You saw the difference yourselves. Right there, in the vote."
:::
