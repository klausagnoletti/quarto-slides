...
- Wooclap presenter tab is open on the second screen, question 1 launched BEFORE this slide. Do not look at the tally while they vote.
...
::: {.notes}
- Live Wooclap result, question 1. If the frame is blank, alt-tab to the Wooclap presenter tab, same picture.
- D is the honest answer for most rooms, say so warmly if D wins
...
::: {.feature-grid style="--fg-cols:3;"}
- A: Pull the cable
- B: Isolate the file server, keep citizen services running
...
::: {.notes}
- Question 2 launched in the Wooclap tab BEFORE this slide. Same code as before, say it once.
...
::: {.notes}
- Live Wooclap result, question 2. Blank frame = alt-tab to the presenter tab.
