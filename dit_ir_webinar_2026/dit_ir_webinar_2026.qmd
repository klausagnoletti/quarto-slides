...
- ~25s, master frame for the next ten minutes
:::
...
::: {style="width:100%; max-width:760px; margin:0.8em auto 0;"}
...
::: {style="width:100%; max-width:520px; margin:0.6em auto 0;"}
![](svg/two-heads.svg){style="width:100%; height:auto; display:block;"}
:::
...
::: {.feature-grid .fragment .fx style="--fg-cols:3; font-size:0.6em; margin-top:0.4em;"}
- Easy: 5+
- Medium: 10+
- Hard: 15+
:::
...
## {background-iframe="https://malwareandmonsters.com" background-interactive="true" visibility="uncounted"}
