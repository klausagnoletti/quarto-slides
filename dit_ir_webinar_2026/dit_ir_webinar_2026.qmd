...
- BEFORE 14:00: logged in to Wooclap in this browser, "Start event" clicked once, the projected screen (QR + code) open in its own tab. Participants who join early see "no vote in progress", that is fine.
- When this slide is up: push question 1 to their phones. Arrow right in the Wooclap tab (or the result slide's frame does it, whichever the test showed). Answers stay hidden: "display answers automatically" is off.
...
```{=html}
<div class="poll-frame"><iframe data-src="https://app.wooclap.com/events/SRCIDYA/questions/6aa106b94026bc4e3711b685" title="Live poll result" allowfullscreen></iframe></div>
```

::: {.notes}
- Question 1 live in this frame. Reveal: click the diagram button at the top of the Wooclap question (show answers). Frame blank = alt-tab to the Wooclap tab, same button there.
- D is the honest answer for most rooms, say so warmly if D wins
...
::: {.notes}
- Push question 2 to their phones now: arrow right in the Wooclap tab (or the result slide's frame, per the test). Same code as before, say it once.
...
```{=html}
<div class="poll-frame"><iframe data-src="https://app.wooclap.com/events/SRCIDYA/questions/6aa1086aa3e3f5575beff39f" title="Live vote result" allowfullscreen></iframe></div>
```

::: {.notes}
- Question 2 live in this frame. Reveal with the diagram button (show answers). Blank frame = alt-tab to the Wooclap tab.
...
<div class="browser__body"><iframe data-src="https://malwareandmonsters.com" title="malwareandmonsters.com" style="opacity:0; transition:opacity .3s;" onload="this.style.background='#fff';this.style.opacity=1"></iframe></div>
</div>
```
