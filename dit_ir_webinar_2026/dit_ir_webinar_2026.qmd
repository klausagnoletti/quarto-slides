...
- When this slide is up: push question 1 to their phones, arrow right in the Wooclap tab. Answers stay hidden: "display answers automatically" is off.
...
::: {.notes}
- Question 1 live in this frame. If it shows a login instead, log in inside the frame once (Wooclap's documented flow). Reveal: the diagram button at the top (show answers). Frame blank = alt-tab to the Wooclap tab, same button there.
- D is the honest answer for most rooms, say so warmly if D wins
