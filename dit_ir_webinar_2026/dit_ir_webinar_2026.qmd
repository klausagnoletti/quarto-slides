...
::: {.notes}
- PRE-SHOW CHECK (before Carlos starts): deck open at http://localhost:8765 via serve.sh, not the file. Wooclap tab: logged in, "Start event" clicked, projected screen (QR + code) up. Deck slide 6 frame logged in (log in inside the frame if it asks). Slide 32 site loads. Second screen: Wooclap tab.
...
- Push question 1 to their phones: arrow right in the Wooclap tab. Phones show no tally.
- Next slide shows the chart by itself. React unscripted, ONE sentence, whatever it is.
...
::: {.notes}
- Question 1 chart, live. Code showing instead of a chart = alt-tab to the Wooclap tab.
- D is the honest answer for most rooms, say so warmly if D wins
...
::: {.notes}
- [SLOW] Say it straight: "The result of that poll is not the point. I didn't ask to learn your answer. I asked to show you what a questionnaire gives you: what people SAY. Nothing about what they DO."
...
- Nobody is pulled in until the vote later; say so, it lowers the guard
- [POINT] Detective first, doubt-first d20 on the first claim
- Watch for one thing: "how sure people sound versus what turns out to be true"
- About five minutes, then the scenario is yours
:::
...
- Next slide shows the chart by itself.
...
- Bridge: "At a real table there is one more thing on the table before anyone acts."
:::
...
::: {.notes}
- Opener, verbatim: "You just picked a letter in thirty seconds. At a real table you also put a card down, face down: what you think this is and how sure you are. That is the part a poll cannot do."
...
::: {.notes}
- Popup ("New to Malware & Monsters?"): dismiss it the instant it appears, before narrating
- [30 SEC MAX] One sentence, cursor to the nav, click straight to the starter guide, then back. No general scrolling.
- Say: "This is the actual site. Starter guide, 3 to 8 colleagues, 90 minutes."
- Fallback if the page is slow or dead: "Trust me, it's live. The address is on the last slide." No troubleshooting on stream.
...
::: {.notes}
- First ask: "Type 1, 2 or 3 in the chat. Which one are you doing Monday?" Glance at the chat yourself, name what you see in one sentence. Quiet chat: "Whatever you typed, that is your Monday."
