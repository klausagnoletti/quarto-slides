...
##  {background-image="images/s01_0.png" background-size="cover" .center}
...
##  {background-image="images/s02_0.png" background-size="cover" .center}
...
## But first let’s talk about games {background-image="images/bg-texture.png" background-size="cover"}

- malwareandmonsters.com

![](images/s03_0.png){.absolute top=189 left=95 width=420}

![](images/s03_1.png){.absolute top=189 left=630 width=294}
...
##  {background-image="images/s04_0.png" background-size="cover" .center}
...
## I have ADHD.. and it’s ok {background-image="images/bg-texture.png" background-size="cover"}
...
##  {background-image="images/s06_1.png" background-size="cover" .center}

![](images/s06_0.png){.absolute top=126 left=420 width=242}
...
## ADHD? ADD? {background-image="images/s07_0.png" background-size="cover"}
...
## The ADHD iceberg {background-image="images/s08_0.png" background-size="cover"}

- @finuccinalfredo

![](images/s08_1.png){.absolute top=0 left=378 width=609}
...
##  {background-image="images/s09_1.png" background-size="cover" .center}

![](images/s09_0.png){.absolute top=105 left=567 width=399}
...
##  {background-image="images/s10_0.png" background-size="cover" .center}
...
## Mitigating {background-image="images/bg-texture.png" background-size="cover"}
...
![](images/s11_0.png){.absolute top=427 left=504 width=515}

![](images/s11_1.png){.absolute top=336 left=536 width=273}
...
## Mitigating (cont’d) {background-image="images/bg-texture.png" background-size="cover"}
...
![](images/s12_0.png){.absolute top=294 left=777 width=200}

![](images/s12_1.jpg){.absolute top=49 left=567 width=284}
...
## Why getting fired was a good thing {background-image="images/s13_0.png" background-size="cover"}
...
##  {background-image="images/s14_0.png" background-size="cover" .center}
...
## Lessons learned {background-image="images/s15_0.png" background-size="cover"}
...
## Talking about Super powers {background-image="images/bg-texture.png" background-size="cover"}

- Talking about Super powers

![](images/s16_0.png){.absolute top=21 left=42 width=578}
...
## Lessons learned (cont’d) {background-image="images/s17_0.png" background-size="cover"}
...
## I asked a friend.. {background-image="images/bg-texture.png" background-size="cover"}
...
## I asked my friend John Strand, CEO of Black Hills Information Security.. {background-image="images/bg-texture.png" background-size="cover"}
...
##  {background-image="images/s20_0.jpg" background-size="cover" .center}
...
## You might wonder.. {background-image="images/s21_0.png" background-size="cover"}
...
##  {background-image="images/s22_0.png" background-size="cover" .center}
...
## Advice for Employers {background-image="images/s23_0.png" background-size="cover"}
...
## One thing is what I think.. {background-image="images/bg-texture.png" background-size="cover"}
...
##  {background-image="images/s25_0.jpg" background-size="cover" .center}
...
## Final Words {background-image="images/bg-texture.png" background-size="cover"}
...
## I am always there to help {background-image="images/s27_0.png" background-size="cover"}
...
![](images/s27_1.png){.absolute top=161 left=32 width=32}

![](images/s27_2.png){.absolute top=280 left=32 width=32}

![](images/s27_3.png){.absolute top=329 left=32 width=32}

![](images/s27_4.png){.absolute top=385 left=32 width=32}

![](images/s27_5.png){.absolute top=140 left=651 width=357}

![](images/s27_6.png){.absolute top=217 left=32 width=32}
...
##  {background-image="images/s28_0.png" background-size="cover" .center}

##  {background-image="images/s29_0.png" background-size="cover" .center}

![](images/s29_1.png){.absolute top=35 left=504 width=525}
