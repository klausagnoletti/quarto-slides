...
Also it's open-source as we want to spread the word about it and make it open-source.  
...
It can be used to make abstract concepts more concrete. For instance, why does IAM matter? What's Zero Trust **really** (now that it's not a fancy product you can buy).  
...
Since HackBack can simulate real events, it can be used to teach employees, customers or other stakeholders how your company work on your red team assignments or use it to make customers or partners understand exactly how you managed to handle that dire incident which was threatening the entire company or country's infrastructure.  
...
::: {.notes}
**Script:** 
As I said before, HackBack is currently mostly used as incident response training. So let me briefly go through the rules to give you a better understaind of how it works.    
